...
const DocumentList: React.FC<DocumentListProps> = ({ className = '' }) => {
  ...
  // Helper function to get first N lines of text
  const PREVIEW_LINES = 8; // ← Change this number to show more/fewer lines
          ...
          {documents.map((document, index) => (
            ...
            >
              ...
              <div className="bg-gray-50 rounded p-3">
                ...
                <pre className="text-sm text-gray-700 whitespace-pre-wrap font-mono leading-relaxed overflow-hidden">
